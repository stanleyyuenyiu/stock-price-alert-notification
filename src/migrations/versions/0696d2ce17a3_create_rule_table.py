...
from modules.rules.entities import utcnow,type_type,operator_type,unit_type,status_type
from sqlalchemy.types import DateTime
from modules.rules.models import EnumUnit, EnumType, EnumStatus
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        Column("status", status_type, nullable=False, default=EnumStatus.NEW),
